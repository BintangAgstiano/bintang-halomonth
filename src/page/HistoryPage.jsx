                        ...
                        <div className="row d-flex flex-column gap-3 " >
                            ...
                            <div className="parent-box-ch">
                                ...
                                <div className="box-content-history col-8">
                                    ...
                                    <FontAwesomeIcon icon={faCaretLeft} style={{ position: 'absolute', transform: "scale(3)", top: '58px', left: '-5px', color: "white" }}></FontAwesomeIcon>

                                    <div className="tanggal">Tanggal :</div>
                                    <div className="content-tanggal">Senin,27 Agustus 2024</div>
                                </div>
                            </div>
                            <div className="parent-box-ch mt-5">
